...
export default function ChoisirPlanPage() {
  ...
  const Feature = ({ text }: { text: string }) => (
    <li style={{fontSize:'13px',color:'#222',display:'flex',gap:'8px',alignItems:'flex-start'}}>
      <span style={{color:'#1D9E75',fontWeight:'700',flexShrink:0}}>✓</span>{text}
    </li>
  )

  const cardStyle = (plan: string) => ({
    background:'#fff',
    borderRadius:'16px',
    padding:'1.75rem',
    ...
    <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#f0fdf4 0%,#e8f5e9 100%)',padding:'2rem',fontFamily:'system-ui,sans-serif'}}>
      <div style={{maxWidth:'900px',margin:'0 auto'}}>
        ...
        <div style={{textAlign:'center',marginBottom:'2rem'}}>
          ...
          <p style={{fontSize:'14px',color:'#555',margin:0}}>30 jours gratuits · Sans carte bancaire · Résiliation en 1 clic</p>
        </div>

        {/* Toggle */}
        <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'12px',marginBottom:'2rem'}}>
          <span style={{fontSize:'14px',fontWeight: billing==='mensuel' ? '700' : '500',color:'#222'}}>Mensuel</span>
          ...
          <span style={{fontSize:'14px',fontWeight: billing==='annuel' ? '700' : '500',color:'#222'}}>
        ...
        {/* Cards — hauteur égale avec boutons en bas */}
        <div style={{display:'flex',gap:'16px',justifyContent:'center',flexWrap:'wrap' as const,marginBottom:'2rem',alignItems:'stretch'}}>

          {/* Starter */}
          <div style={cardStyle('starter')} onClick={() => setSelected('starter')}>
            <div style={{fontSize:'15px',fontWeight:'700',marginBottom:'4px',color:'#111'}}>Starter</div>
            <div style={{fontSize:'28px',fontWeight:'800',margin:'8px 0',color:'#111'}}>Gratuit <span style={{fontSize:'14px',fontWeight:'400',color:'#555'}}>/ 30 jours</span></div>
            <p style={{fontSize:'13px',color:'#444',marginBottom:'1rem',lineHeight:'1.5'}}>Testez toutes les fonctionnalités, sans engagement.</p>
          ...
          {/* Pro */}
          <div style={{...cardStyle('pro'),position:'relative' as const}} onClick={() => setSelected('pro')}>
            ...
            <div style={{fontSize:'15px',fontWeight:'700',marginBottom:'4px',color:'#111'}}>Pro</div>
            <div style={{fontSize:'28px',fontWeight:'800',margin:'8px 0',color:'#111'}}>{prix.pro} <span style={{fontSize:'14px',fontWeight:'400',color:'#555'}}>HT / mois</span></div>
            <p style={{fontSize:'13px',color:'#444',marginBottom:'1rem',lineHeight:'1.5'}}>Pour les artisans et TPE qui veulent aller vite.</p>
            <ul style={{listStyle:'none',padding:0,margin:'0 0 1.5rem',display:'flex',flexDirection:'column' as const,gap:'8px',flex:1}}>
          ...
          {/* Business */}
          <div style={cardStyle('business')} onClick={() => setSelected('business')}>
            <div style={{fontSize:'15px',fontWeight:'700',marginBottom:'4px',color:'#111'}}>Business</div>
            <div style={{fontSize:'28px',fontWeight:'800',margin:'8px 0',color:'#111'}}>{prix.business} <span style={{fontSize:'14px',fontWeight:'400',color:'#555'}}>HT / mois</span></div>
            <p style={{fontSize:'13px',color:'#444',marginBottom:'1rem',lineHeight:'1.5'}}>Pour les entreprises avec plusieurs collaborateurs.</p>
            <ul style={{listStyle:'none',padding:0,margin:'0 0 1.5rem',display:'flex',flexDirection:'column' as const,gap:'8px',flex:1}}>
        ...
        <div style={{textAlign:'center'}}>
          ...
          <p style={{fontSize:'12px',color:'#666',marginTop:'12px'}}>💳 Sans carte bancaire · Résiliation en 1 clic</p>
        </div>
