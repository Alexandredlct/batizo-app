                          ...
                          <div style={{minWidth:0,flex:1}}>
                            ...
                            <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:5}}>
                              {editingTitre===c.id ? (
                                ...
                                <>
                                  <span style={{fontSize:16,fontWeight:700,color:'#111'}}>{c.client} — {c.titre}</span><span style={{fontSize:12,color:'#888',fontWeight:400,marginLeft:10,color:'#444',fontWeight:500}}>{fmt(c.montantDevis)} HT devisé · <span style={{color:montantFacture===0?'#888':G,fontWeight:500}}>{fmt(montantFacture)} HT facturé</span></span><span style={{fontSize:12,fontWeight:400,color:'#666',marginLeft:8}}>{fmt(c.montantDevis)} HT · <span style={{color:montantFacture===0?'#aaa':G}}>{fmt(montantFacture)} HT facturé</span></span>
