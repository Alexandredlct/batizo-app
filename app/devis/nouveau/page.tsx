  ...
  return(
    <div style={{display:'flex',height:'100vh',fontFamily:params.police||'system-ui,sans-serif',background:'#f0f2f5',overflow:'hidden'}}>
      ...
      {showEditClientModal&&client&&(()=>{
        ...
        const[nomContact,setNomContact]=useState((client as any).nomContact||'')
        const[poste,setPoste]=useState((client as any).poste||'')
        const[adresseIdentique,setAdresseIdentique]=useState((client as any).adresseIdentique!==false)
